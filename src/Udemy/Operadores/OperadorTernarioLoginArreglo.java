...
public class OperadorTernarioLoginArreglo
{
    public static void main(String[] args)
    {
        ...
        {
            //Cuando existen muchos valores es mejor utilizar el for con un if para no consumir recursos
            //Pero si son pocos valores se puede utilizar el operador ternario y el proceso se realiza de la siguiente manera
            //Si lo encuentra el valor seria unicamente true no se puede de lo contrario false porque el sistema seguiria iterando
        ...
        //De igual manera esta tambien se podria convertir a un operador ternario
        //Para realizar la operacion ternaria de una autenticación primero debemos crear una nueva variable
